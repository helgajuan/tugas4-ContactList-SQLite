...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    private ArrayList name_id, number_id, age_id;

    public MyAdapter(Context context, ArrayList name_id, ArrayList number_id, ArrayList age_id) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView name_id, number_id, age_id;
